...
type NecoWalletCenterClient interface {
	InitUserWallet(ctx context.Context, in *InitUserWalletRequest, opts ...grpc.CallOption) (*UserWallet, error)
...
func (c *necoWalletCenterClient) InitUserWallet(ctx context.Context, in *InitUserWalletRequest, opts ...grpc.CallOption) (*UserWallet, error) {
	out := new(UserWallet)
	err := c.cc.Invoke(ctx, "/NecoWalletCenter/InitUserWallet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NecoWalletCenterServer interface {
	InitUserWallet(context.Context, *InitUserWalletRequest) (*UserWallet, error)
...
func (UnimplementedNecoWalletCenterServer) InitUserWallet(context.Context, *InitUserWalletRequest) (*UserWallet, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitUserWallet not implemented")
}
...
func _NecoWalletCenter_InitUserWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitUserWalletRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NecoWalletCenterServer).InitUserWallet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/NecoWalletCenter/InitUserWallet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NecoWalletCenterServer).InitUserWallet(ctx, req.(*InitUserWalletRequest))
	}
...
var NecoWalletCenter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "InitUserWallet",
			Handler:    _NecoWalletCenter_InitUserWallet_Handler,
		},
		{
